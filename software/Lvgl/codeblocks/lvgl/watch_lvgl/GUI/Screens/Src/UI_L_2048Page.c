...
///////////////////// Page Manager //////////////////
page_t GamePage_2048 = {ui_Game2048Page_screen_init, ui_Game2048Page_screen_deinit, &ui_Game2048Page};
...
void ui_Game2048Page_screen_init(void)
{
    ...
    lv_obj_set_style_bg_color(ui_Game2048Page, lv_color_hex(0xffffff), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_color(ui_Game2048ScLabel, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT);
