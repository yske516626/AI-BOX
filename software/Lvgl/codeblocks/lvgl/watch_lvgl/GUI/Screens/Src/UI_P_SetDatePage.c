...
void ui_DateTimeSetPage_screen_init(void)
{
    ...
    lv_obj_clear_flag(ui_DateTimeSetPage, LV_OBJ_FLAG_SCROLLABLE);     
    ...
    lv_obj_clear_flag(ui_APPSyPanel, LV_OBJ_FLAG_SCROLLABLE);      
    ...
    lv_obj_set_width(ui_APPSyLabel, LV_SIZE_CONTENT); 
    lv_obj_set_height(ui_APPSyLabel, LV_SIZE_CONTENT);   
    ...
    lv_obj_clear_flag(ui_DateSetPanel, LV_OBJ_FLAG_SCROLLABLE);    
    ...
    lv_obj_set_width(ui_DateSetLabel, LV_SIZE_CONTENT);   
    lv_obj_set_height(ui_DateSetLabel, LV_SIZE_CONTENT);    
    ...
    lv_obj_set_width(ui_DateSetLabel1, LV_SIZE_CONTENT);  
    lv_obj_set_height(ui_DateSetLabel1, LV_SIZE_CONTENT);    
    ...
    lv_obj_set_width(ui_DateSetLabel2, LV_SIZE_CONTENT);   
    lv_obj_set_height(ui_DateSetLabel2, LV_SIZE_CONTENT);   
    ...
    lv_obj_set_width(ui_DateSetLabel3, LV_SIZE_CONTENT);   
    lv_obj_set_height(ui_DateSetLabel3, LV_SIZE_CONTENT);    
    ...
    lv_obj_clear_flag(ui_TimeSetPanel, LV_OBJ_FLAG_SCROLLABLE);     
    ...
    lv_obj_set_width(ui_TimeSetLabel, LV_SIZE_CONTENT);  
    lv_obj_set_height(ui_TimeSetLabel, LV_SIZE_CONTENT);    
    ...
    lv_obj_set_width(ui_TimeSetLabel1, LV_SIZE_CONTENT);  
    lv_obj_set_height(ui_TimeSetLabel1, LV_SIZE_CONTENT);    
    ...
    lv_obj_set_width(ui_TimeSetLabel2, LV_SIZE_CONTENT);   
    lv_obj_set_height(ui_TimeSetLabel2, LV_SIZE_CONTENT);    
    ...
    lv_obj_set_width(ui_TimeSetLabel3, LV_SIZE_CONTENT);  
    lv_obj_set_height(ui_TimeSetLabel3, LV_SIZE_CONTENT);    
    ...
    lv_obj_add_event_cb(ui_DateTimeSetPage, ui_event_DateTimeSetPage, LV_EVENT_GESTURE, NULL);
...
void ui_DateSetPage_screen_init(void)
{
    ...
    lv_obj_clear_flag(ui_DateSetPage, LV_OBJ_FLAG_SCROLLABLE);    
    ...
    lv_obj_set_width(ui_YearSetRoller, LV_SIZE_CONTENT);  
    ...
    lv_obj_set_width(ui_MonthSetRoller, LV_SIZE_CONTENT);  
    ...
    lv_obj_set_width(ui_DaySetRoller, LV_SIZE_CONTENT);  
    ...
    lv_obj_add_flag(ui_DateSetOKButton, LV_OBJ_FLAG_SCROLL_ON_FOCUS);    
    lv_obj_clear_flag(ui_DateSetOKButton, LV_OBJ_FLAG_SCROLLABLE);      
    ...
    lv_obj_set_width(ui_DateSetOKicon, LV_SIZE_CONTENT);   
    lv_obj_set_height(ui_DateSetOKicon, LV_SIZE_CONTENT);   
    lv_obj_set_align(ui_DateSetOKicon, LV_ALIGN_CENTER);
    lv_label_set_text(ui_DateSetOKicon, LV_SYMBOL_ok);
    lv_obj_set_style_text_font(ui_DateSetOKicon, &ui_icon_MenuOderPage34, LV_PART_MAIN | LV_STATE_DEFAULT);
...
void ui_TimeSetPage_screen_init(void)
{
    ...
    lv_obj_clear_flag(ui_TimeSetPage, LV_OBJ_FLAG_SCROLLABLE);      
    ...
    lv_obj_set_width(ui_HourSetRoller, LV_SIZE_CONTENT);   
    ...
    lv_obj_set_width(ui_TimePoint, LV_SIZE_CONTENT);  
    lv_obj_set_height(ui_TimePoint, LV_SIZE_CONTENT);    
    ...
    lv_obj_set_width(ui_MinSetRoller, LV_SIZE_CONTENT);  
    ...
    lv_obj_set_width(ui_TimePoint1, LV_SIZE_CONTENT);   
    lv_obj_set_height(ui_TimePoint1, LV_SIZE_CONTENT);   
    ...
    lv_obj_set_width(ui_SecSetRoller, LV_SIZE_CONTENT);  
    ...
    lv_obj_add_flag(ui_TimeSetOKButton, LV_OBJ_FLAG_SCROLL_ON_FOCUS);    
    lv_obj_clear_flag(ui_TimeSetOKButton, LV_OBJ_FLAG_SCROLLABLE);     
    ...
    lv_obj_set_width(ui_TimeSetOKicon, LV_SIZE_CONTENT);   
    lv_obj_set_height(ui_TimeSetOKicon, LV_SIZE_CONTENT);    
    lv_obj_set_align(ui_TimeSetOKicon, LV_ALIGN_CENTER);
    lv_label_set_text(ui_TimeSetOKicon, LV_SYMBOL_ok);
    lv_obj_set_style_text_font(ui_TimeSetOKicon, &ui_icon_MenuOderPage34, LV_PART_MAIN | LV_STATE_DEFAULT);
